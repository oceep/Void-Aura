...
const SidebarComponent: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Sidebar Content */}
      <aside 
        className={`fixed md:relative z-30 flex flex-col h-full bg-[#0f0f12]/95 backdrop-blur-xl border-r border-white/5 transition-all duration-300 ease-in-out
          ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'} 
          ${isOpen ? (isCompact ? 'w-[80px]' : 'w-[280px]') : 'w-0 border-r-0 overflow-hidden'}
        `}
      >
