...
export const LandingPage: React.FC<LandingPageProps> = ({ onLogin, onSignUp, onStartChat }) => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      }, 300); // Faster exit animation (was 500)
    }, 2500); // Faster cycle (was 3500)
  ...
  const renderContent = () => {
    switch (activePage) {
      case 'about':
        return (
          <div className="w-full max-w-4xl mx-auto text-center animate-fade-up duration-300 will-change-transform px-6 pt-10">
      ...
      case 'features':
        return (
          <div className="w-full max-w-5xl mx-auto animate-fade-up duration-300 will-change-transform px-6 pt-10">
      ...
      case 'learn-more':
        return (
          <div className="w-full max-w-3xl mx-auto animate-fade-up duration-300 will-change-transform px-6 pt-10">
      ...
      default:
        return (
          <>
            <div className="mb-8 animate-fade-in duration-300 will-change-transform group cursor-pointer" onClick={onStartChat}>
            ...
            <h1 className="text-5xl md:text-8xl font-bold tracking-tighter mb-6 max-w-5xl leading-[1.1] animate-fade-up duration-300 will-change-transform">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mb-10 leading-relaxed animate-fade-up duration-300 font-light will-change-transform" style={{animationDelay: '0.1s'}}>
                Oceep không chỉ là AI. Đó là cuộc trò chuyện thấu hiểu, thông minh và phát triển cùng bạn. Khám phá tương lai ngay hôm nay.
            </p>

            <div className="flex flex-col md:flex-row gap-5 w-full max-w-md md:max-w-none justify-center animate-fade-up duration-300 will-change-transform mb-16" style={{animationDelay: '0.15s'}}>
                <button 
                    onClick={onStartChat}
            ...
            <div className="w-full max-w-4xl mx-auto mb-20 animate-fade-up duration-300 will-change-transform" style={{animationDelay: '0.2s'}}>
            ...
            {/* Suggested Prompts */}
            <div className="w-full max-w-6xl px-4 text-left animate-fade-up duration-300 will-change-transform" style={{animationDelay: '0.25s'}}>
